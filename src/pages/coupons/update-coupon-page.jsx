...
const UpdateCouponPage = () => {
    ...
    useEffect(() => {
        if (coupon) {
            formik.setValues({
                ...
                coupon_amount: coupon.coupon_amount != null ? String(coupon.coupon_amount) : "",
                allow_free_shipping: coupon.allow_free_shipping ?? false,
                is_individual_use: coupon.is_individual_use ?? false,
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            const result = await dispatch(updateCoupon({id: couponID, data: {...values, coupon_amount: Number(values.coupon_amount)}}));
