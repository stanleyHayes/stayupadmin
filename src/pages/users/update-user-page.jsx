...
import {fetchUser, updateUser, selectUsers} from "../../redux/features/users/users-slice";
...
const UpdateUserPage = () => {
    ...
    const formik = useFormik({
        initialValues: {firstName: "", lastName: "", email: "", username: "", phone: "", role: "customer", status: "ACTIVE"},
        ...
        onSubmit: async (values) => {
            ...
            if (!result.error) navigate(`/users/${userID}`);
        }
    });
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item size={{xs: 12, md: 4}}>
                                ...
                                <Paper elevation={0} sx={{p: 3}}>
                                    <Divider sx={{mb: 2}}/>
                                    <Stack spacing={1}>
                                        <Button type="submit" variant="contained" color="secondary" fullWidth disabled={userLoading}>Save Changes</Button>
